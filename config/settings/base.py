...
APPS_DIR = ROOT_DIR / "architecture_tool_django"
env = environ.Env()
...
LOCAL_APPS = [
    ...
    "architecture_tool_django.modeling.apps.ModelingConfig",
...
MIGRATION_MODULES = {"sites": "architecture_tool_django.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "architecture_tool_django.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Frank Dai""", "yongjindai09@gmail.com")]
...
SYNC_TO_CONFLUENCE = env.bool("SYNC_TO_CONFLUENCE", False)
if SYNC_TO_CONFLUENCE:
    CONFLUENCE_URL = env("CONFLUENCE_URL")
    API_KEY = env("API_KEY")
    CONFLUENCE_USER = env("CONFLUENCE_USER")
    CONFLUENCE_PASS = env("CONFLUENCE_PASS")

SYNC_TO_GITLAB = env.bool("SYNC_TO_GITLAB", False)
if SYNC_TO_GITLAB:

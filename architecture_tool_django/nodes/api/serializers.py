...
class NodeSerializer(serializers.ModelSerializer):
    ...
    def validate_attributeSet(self, value):
        v = Draft4Validator(
            self.instance.nodetype.attribute_schema.schema,
    ...
    #     for edge_data in self.initial_data['edges']:
    #         # TODO attributeSet not supported in edges yet
    #         edge_data.pop('attributeSet', None)

    #         Edge.objects.create(node=node, **edge_data)

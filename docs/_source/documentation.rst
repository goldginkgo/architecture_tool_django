...
Documentation can be written as rst files in the `architecture_tool_django/docs/_source`.
...
This can be done in the docker container:
    :: 
        ...
        docker-compose -f local.yml run --rm docs make -f Makefile.mk apidocs
